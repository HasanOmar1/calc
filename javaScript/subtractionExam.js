...
firstNum1.innerText = parseInt(Math.ceil(Math.random() * 1000));
secondNum1.innerText = parseInt(Math.ceil(Math.random() * 1000));
...
firstNum2.innerText = parseInt(Math.ceil(Math.random() * 1000));
secondNum2.innerText = parseInt(Math.ceil(Math.random() * 1000));
...
firstNum3.innerText = parseInt(Math.ceil(Math.random() * 1000));
secondNum3.innerText = parseInt(Math.ceil(Math.random() * 1000));
...
firstNum4.innerText = parseInt(Math.ceil(Math.random() * 1000));
secondNum4.innerText = parseInt(Math.ceil(Math.random() * 1000));
